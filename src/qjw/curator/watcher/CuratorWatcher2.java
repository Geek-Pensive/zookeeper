...
public class CuratorWatcher2 {
	...
	public static void main(String[] args) throws Exception {
		...
		//4 建立一个PathChildrenCache缓存,第三个参数为是否接受节点数据变化的内容 如果为false则不接受
		...
		cache.getListenable().addListener(new PathChildrenCacheListener() {
			...
			public void childEvent(CuratorFramework cf, PathChildrenCacheEvent event) throws Exception {
				...
				case CHILD_ADDED:
					System.out.println("CHILD_ADDED 路径 :" + event.getData().getPath());
					System.out.println("CHILD_ADDED 数据 :" + new String(event.getData().getData(),"utf-8"));
					break;
				case CHILD_UPDATED:
				    	System.out.println("CHILD_UPDATED 路径 :" + event.getData().getPath());
				    	System.out.println("CHILD_UPDATED 数据 :" + new String(event.getData().getData(),"utf-8"));
					break;
				case CHILD_REMOVED:
				    	System.out.println("CHILD_REMOVED 路径 :" + event.getData().getPath());
					System.out.println("CHILD_REMOVED 数据 :" + new String(event.getData().getData(),"utf-8"));
					break;
				default:
					break;
				}
